...
public class TestMyPoint {
    ...
    public static void main(String[] args) {
        ...
        MyPoint point1 = new MyPoint(); // Opretter nyt objekt (punkt) ud fra klassen MyPoint
        MyPoint point2 = new MyPoint(2.5,3.1); // Opretter nyt objekt (punkt) ud fra klassen MyPoint
